...
export default async function ApplicationPage({
  ...
  const jobId = parseInt(resolvedParams.jobId, 10);

  // 2. Extract jobTitle from search parameters (with default)
  const jobTitle = resolvedSearchParams.title || "Job Opening";
        ...
        <main className="min-h-screen py-20 flex items-center justify-center">
          <div className="text-center p-8 bg-white shadow-xl rounded-lg">
            ...
            <p className="text-gray-600">
              Invalid job application link. Please go back to the careers page.
            </p>
            <a
              href="/careers"
