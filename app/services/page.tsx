...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* =================================================================== */}
      {/* START: Revamped Support Section                  */}
      {/* =================================================================== */}
      ...
      {/* <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/services" className="bg-[#8b0303] hover:bg-opacity-90 text-white px-8 py-4 rounded-lg font-semibold transition-all hover:scale-105 whitespace-nowrap cursor-pointer inline-block">
