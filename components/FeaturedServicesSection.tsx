...
export default function FeaturedServicesSection() {
  ...
  useEffect(() => {
    if (!sectionRef.current || !headingContentRef.current || !cardsContainerRef.current) {
      return;
    }
