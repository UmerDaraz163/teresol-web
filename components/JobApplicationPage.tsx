...
export default function JobApplicationPage({ jobId, jobTitle }: Props) {
  ...
  const handleAlphaNumericInput = (e: React.FormEvent<HTMLInputElement>) => {
    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 bg-white shadow-xl rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <fieldset className="p-6 border border-gray-200 rounded-md space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-700"
              >
                Father / Spouse Name (as per CNIC)
              </label>
              <input
                type="text"
          ...
          <div>
            <label
              htmlFor="any_medical_illness"
              className="block text-sm font-medium text-gray-700"
            >
              Any medical illness? (Mention only if relevant to work)
            </label>
            <textarea
              name="any_medical_illness"
              id="any_medical_illness"
              rows={1}
              onInput={handleAlphaInput}
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
            ></textarea>
        ...
        <fieldset className="p-6 border border-gray-200 rounded-md space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-700"
              >
                Degree Level (Masters/Bachelors/Intermediate)
              </label>
              <input
                type="text"
                name="highest_degree"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label
                htmlFor="degree_completion_year"
                className="block text-sm font-medium text-gray-700"
              >
                Completion Year
              </label>
              <input
                type="number"
                name="degree_completion_year"
                id="degree_completion_year"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
              />
            </div>
          </div>
          ...
          <div>
            <label
              htmlFor="future_study_plans"
              className="block text-sm font-medium text-gray-700"
            >
              Future plans of study (UG/PG /PHD)?
            </label>
            <input
              type="text"
              name="future_study_plans"
              id="future_study_plans"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
            />
          </div>
        </fieldset>
        ...
        <fieldset className="p-6 border border-gray-200 rounded-md space-y-4">
          ...
          <div>
            <label
              htmlFor="professional_exp_years"
              className="block text-sm font-medium text-gray-700"
            >
              Professional Experience (In Years, excluding study duration)
            </label>
            <input
              type="number"
              step="0.5"
              name="professional_exp_years"
              id="professional_exp_years"
              defaultValue={0}
              min="0"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
            />
          ...
          <fieldset className="p-4 border border-gray-300 rounded-md space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700"
                >
                  Current Salary (with Proof)
                </label>
                <input
                  type="text"
                  name="current_salary"
                  id="current_salary"
                  placeholder="e.g. 50,000 PKR + benefits"
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
                />
              </div>
            </div>
            <div>
              <label
                htmlFor="tenure_last_job"
                className="block text-sm font-medium text-gray-700"
              >
                Tenure of last working place
              </label>
              <input
                type="text"
                name="tenure_last_job"
                id="tenure_last_job"
            ...
            <div>
              <label
                htmlFor="reason_for_quitting"
                className="block text-sm font-medium text-gray-700"
              >
                Reason to quit your last job
              </label>
              <textarea
                name="reason_for_quitting"
                id="reason_for_quitting"
                rows={2}
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
              ></textarea>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label
                ...
                className="block text-sm font-medium text-gray-700"
              >
                Expected Salary from TeReSol
              </label>
              <input
                type="text"
                name="expected_salary"
                id="expected_salary"
                placeholder="e.g. 70,000 PKR"
          ...
          <div>
            <label
              htmlFor="expected_stay_duration"
              className="block text-sm font-medium text-gray-700"
            >
              If selected, how long can you stay with us?
            </label>
            <input
              type="text"
              name="expected_stay_duration"
              id="expected_stay_duration"
              placeholder="e.g. 2 years minimum / Long-term"
              className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
            />
          </div>
          ...
          <div className="pt-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Are you willing to travel national/international?
            </label>
        ...
        <fieldset className="p-6 border border-gray-200 rounded-md space-y-4">
          ...
          <div className="pt-2">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Have you been shortlisted for a job elsewhere?
            </label>
            <div className="flex space-x-4">
              <label className="inline-flex items-center">
                <input
                  type="radio"
                  name="shortlisted_elsewhere"
                  value="Yes"
                  className="form-radio text-blue-600"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label
                htmlFor="other_org_name"
                className="block text-sm font-medium text-gray-700"
              >
                If Yes, Name of organization applied to
              </label>
              <input
                type="text"
                name="other_org_name"
            ...
            <div>
              ...
              <input
                type="text"
                name="other_app_status"
                id="other_app_status"
                placeholder="e.g. Awaiting final offer / Interview stage"
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm"
              />
            </div>
          </div>
          ...
          <fieldset className="p-4 border border-gray-300 rounded-md space-y-3">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Do you have any relatives/friends at TeReSol?
              </label>
              <div className="flex space-x-4">
                <label className="inline-flex items-center">
                  <input
                    type="radio"
                    name="relative_at_teresol"
                    value="Yes"
                    className="form-radio text-blue-600"
                  />
                  <span className="ml-2 text-gray-700">Yes</span>
          ...
          <div>
            <label
              htmlFor="candidate_notes"
              className="block text-sm font-medium text-gray-700"
            >
              Another thing you want to share
            </label>
            <textarea
        ...
        <div className="p-6 border border-blue-300 bg-blue-50 rounded-md space-y-2">
          <label htmlFor="cv" className="block text-lg font-bold text-blue-700">
            Upload CV / Resume
          </label>
          <input
            type="file"
